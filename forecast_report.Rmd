...
```{r}
metpath <- paste0("C:/Users/borre/Documents/lg-forecast/drivers/met_archive/meteo_fc_", 
                  initial_fc_date, ".csv")
...
```{r}
ltpath <- paste0("C:/Users/borre/Documents/lg-forecast/temp_forecasts/fc_", initial_fc_date, ".csv")
...
```{r}
atn_out <- read.csv("C:/Users/borre/Documents/lg-forecast/ATN_out/output/atn_fc.csv")
```
...
```{r}
chla <- read.csv("GLMAED/archive_fc/chla.csv")
...
```{r}
phs <- read.csv("GLMAED/archive_fc/phs.csv")
...
```{r}
oxy <- read.csv("GLMAED/archive_fc/oxy.csv")
...
```{r}
nit <- read.csv("GLMAED/archive_fc/nit.csv")
